...
>>>>>>> 9efd25a3f396d881d4a9e72f2faeb0674a78d896
...
- DriveWise generates a global score that reflects three key dimensions:
	- Driving Behavior Score (smoothness, anticipation, safety)
	- Law-Compliance Score (seatbelt usage, focus, distraction)
	- Eco-Driving Score (energy efficiency, CO₂ impact)
- The user can follow their evolution over time through clean and informative dashboards.

## Real-Time Alerts & Dashboards

- The application provides:
	- instant warnings for detected risks
	- a complete overview of each trip
	- historical performance trends
	- a driver-monitoring view
	- advice to improve overall performance
...
- Road safety: fewer accidents caused by fatigue or distraction
- Environment: reduced fuel consumption and lower emissions
...
>>>>>>> 280fcba04c2db948c15163a40ae2ce18df26cb26
